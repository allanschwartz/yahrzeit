...
// constructor for the LedMatrix, an instance of the 'YyzPixel' class
// note that YyzPixel is called with portIDs    ( DI, OE, CP, ST )
enum { DI_pin = 10, OE_pin = 11, CP_pin = 12, ST_pin = 13 };    // for prototype fixture 
// enum { DI_pin = 42, OE_pin = 44, CP_pin = 46, ST_pin = 48 };    // for fabbed tail-shield board.
YyzPixel yyzPixels(   DI_pin, OE_pin, CP_pin, ST_pin );
LedWall ledWall(yyzPixels);        // create an instance of the class, giving us ledWall primitives
CmdProc cmdProc(ledWall);           // create an instance of the class, giving us command processing functions
...
const char VersionString[]  =
    "\tLED Controller, V.30, 2026-04-29\n"
    "\tCopywrite (c) 2008,2015,2026 AMS Consulting\n"
    "\t----------\n";
/*
enum ResultIds {
